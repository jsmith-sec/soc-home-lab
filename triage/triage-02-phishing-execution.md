...
**Summary:** An Office process (`winword.exe`) spawned an encoded PowerShell command on
`DC01`, the classic macro-to-execution pattern. Confirmed **true positive** (phishing
execution); recommended host containment and mail-gateway scoping.
